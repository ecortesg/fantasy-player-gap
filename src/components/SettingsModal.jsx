...
function SettingsModal({ children }) {
  ...
  return ReactDom.createPortal(
    <>
      ...
      <div className="fixed top-1/2 left-1/2 bg-slate-50 dark:bg-slate-800 dark:text-white z-30 translate-y-[-50%] translate-x-[-50%] w-full md:w-3/4 xl:w-1/2 h-full md:h-3/4 md:rounded-3xl">
        {children}
      </div>
    </>,
